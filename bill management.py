...
Label(f,font=("Lucida Calligraphy",15,"bold"),text="Dosa......Rs.70/plate",fg="black",bg="lightgreen").place(x=10,y=80)
...
Label(f,font=("Lucida Calligraphy",15,"bold"),text="Pancakes..Rs.30/pack",fg="black",bg="lightgreen").place(x=10,y=230)
Label(f,font=("Lucida Calligraphy",15,"bold"),text="Omelette..Rs.25/plate",fg="black",bg="lightgreen").place(x=10,y=260)
...
lb1_juice=Label(f1,font=("aria",20,"bold"),text="Juice",width=12,fg="blue4")
lb1_pancakes=Label(f1,font=("aria",20,"bold"),text="Pancakes",width=12,fg="blue4")
lb1_omelette=Label(f1,font=("aria",20,"bold"),text="Omelette",width=12,fg="blue4")
...
lb1_omelette.grid(row=7,column=0)
...
entry_omelette=Entry(f1,font=("aria",20,"bold"),textvariable=omelette,bd=6,width=8,bg="lightpink")
...
entry_omelette.grid(row=7,column=1)
